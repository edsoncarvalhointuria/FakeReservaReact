...
function Filtro({ setParams, params, prods }) {
    const categorias = [
        ...new Set(
            prods.reduce((acc, currentValue) => {
                acc = acc.concat(JSON.parse(currentValue.categorias));
                return acc;
            }, [])
        ),
    ];
    ...
    const tamanhos = prods.reduce((acc, currentValue) => {
        JSON.parse(currentValue.tamanhos).map((v) =>
    ...
    const cores = prods.reduce((acc, currentValue) => {
        JSON.parse(currentValue?.cores).map((v) =>
                ...
                <div className="filtro__titulo-container">
                    <div className="filtro__titulo">
                        <div className="filtro__img">
                            <img
                                src="https://raw.githubusercontent.com/edsoncarvalhointuria/FakeReservaReact/bb74e2bd90ce815cd798f96f25942c31221e7eac/dist/filters-2-svgrepo-com.svg"
                                alt="Imagem Filtro"
                            />
                        </div>
                        <p>Filtrar</p>
