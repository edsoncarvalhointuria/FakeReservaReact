...
function Item() {
    ...
    //         getItensSemelhantes(JSON.parse(prod.categorias)[0])
    //             .then((res) => (itensSemlhantes = res.data))
    //             .catch((err) => console.log(err));

    //         setOpcao({
    //             cor: JSON.parse(prod.cores)[0].cor,
    //             tamanho: JSON.parse(prod.tamanhos)[0],
    //         });
    //     })();
    // }, []);
                    ...
                    <div className="item__container">
                        ...
                        <div className="item__infos">
                            <p className="item__caminho">
                                <Link to="/" className="item__caminho-link">
                                    Home
                                </Link>
                                {">"}
                                <Link to="/" className="item__caminho-link">
                            ...
                            <div className="item__info-preco">
                                <button type="submit" className="item__botao">
                                    <div></div>
                                </button>
                            ...
                            <div className="item__cashback">
                                <span>Ganhe {prod?.cashback}%</span> de Cashback
                            </div>
                            ...
                            <div className="item__lista">
                                ...
                                <ul className="item__tamanhos">
                                    {JSON.parse(prod?.tamanhos).map((v, i) => (
                                        <li key={i}>
                                            <input
                                                type="radio"
                                                name="tamanhos"
                            ...
                            <button
                                ...
                                className="item__add"
                                onClick={(e) => {
                                    addProduto(id, opcoes.tamanho, opcoes.cor);
                                    redirect("/carrinho");
                                }}
                            >
                                Adicionar à Sacola
                            ...
                            <p className="item__subtitulo">
                                ...
                                <span> retire em loja sem pagar frete </span>
                            </p>
                            ...
                            <div className="item__descricao item__descricao--abrir">
                                ...
                                <div className="item__descricao-desc">
                                    <p className="item__descricao-info">
                                        ...
                                        sofisticada e estruturada, ideal para
                                        mulheres elegantes e modernas. Feito em
                                        jeans, é confortável e pode ser usado
                                        com blazer sobrepondo camisetas.
                                        Trazendo elegância, conforto e
                                        modernidade. Mini Colete Feminina
                                        Reversa produzido eticamente no Brasil.
                                        Comprando esta peça, você viabiliza
                                        cinco pratos de comida através do nosso
                                        programa 1P5P. A modelo mede 1,77 m de
                                        altura e 74 cm de busto.
                                    </p>
